...
import 'package:snapta/bloc/lates_post_bloc.dart';
import 'package:snapta/bloc/search_tag_bloc.dart';
import 'package:snapta/bloc/search_user_bloc.dart';
...
import 'package:snapta/models/search_post_model.dart' as postsearch;
...
class _ProfileState extends State<SerchFeed>
  ...
  // Widget _searchUsers(BuildContext context) {
  //   listScrollController = new ScrollController()..addListener(_scrollListener);
  //   return Stack(
  //     children: [
  //       SingleChildScrollView(
  ...
  //       padding: const EdgeInsets.only(top: 10),
  //       child: !isSearch
  //           ? Center(child: Text('Type any user name for get details'))
